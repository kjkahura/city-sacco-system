...
// Mambu-style error envelope.
// https://docs.mambu.com/api/ -> Responses
...
// Mambu pagination: offset/limit query params, plus a paginationDetails header
// contract. Cursor pagination is exposed on the search endpoints.
...
// Mambu detailsLevel: BASIC strips nested/expanded objects, FULL returns everything.
...
// Mambu sortBy syntax: "field:ASC" / "field:DESC"
...
// Mambu search filter operators, used by the POST /:resource:search endpoints.
const OPERATORS = {
  EQUALS: (v, val) => v === val,
